...
addprofile()
{
	cat > ${PREFIX}/share/jokeralpine/etc/profile <<- EOM
...
addmotd() {
	cat > ${PREFIX}/share/jokeralpine/etc/profile.d/motd.sh  <<- EOM
...
updrepos() {
	cp ${PREFIX}/share/jokeralpine/etc/apk/repositories ${PREFIX}/share/jokeralpine/etc/apk/repositories.bak
	cat > ${PREFIX}/share/jokeralpine/etc/apk/repositories <<- EOM
...
addresolvconf ()
{
	printf "nameserver 8.8.8.8\nnameserver 8.8.4.4" > ${PREFIX}/share/jokeralpine/etc/resolv.conf
}
